...
# coding=utf-8
##########################################################
# AUTHOR : RED-MAFIA(RK)ALIRAZA(AK)#
# CONTAK : 03188214452 [WHATSAPP]                       #
# GITHUB : HTTPS://GITHUB.COM/RED-MAFIA                   #
##########################################################
#   OPEN SOURCE YA NGAB JANGAN DI PERJUAL BELIKAN OKH    #
##########################################################
#   JIKA ADA EROR TOLONG WHATSAPP SAYA : 03188214452    #
##########################################################
...
def banner():
	print('''
\033[0;31m    __  ________  ______
\033[0;32m   /  |/  /  _/ |/ /  _/   • CODE BY RED-MAFIA(ALIRAZA) •
\033[0;33m  / /|_/ // //    // / • HTTPS://GITHUB.COM/Red-Mafia•
\033[0;34m /_/  /_/___/_/|_/___/
''')
...
def mmmasuk():
 ...
 #M,P))
	...
	print("%s [!] Isi dengan benar "%(O));exit()
    	...
    	jeeck(" \033[0;32m[\033[0;35m+\033[0;36m]\033[0;00m  ================================================")
        jeeck(" \033[0;32m[\033[0;35m+\033[0;36m]\033[0;00m                JOIN GROUP WA + FB ")
        jeeck(" \033[0;32m[\033[0;35m+\033[0;36m]\033[0;00m  ================================================")
        jeeck(" \033[0;32m[\033[0;35m+\033[0;36m]\033[0;00m  (1 Komunitas termux indonesia [ FACEBOOK ] ")
        jeeck(" \033[0;32m[\033[0;35m+\033[0;36m]\033[0;00m  (2 Xnxcode TEAM [ WHATSAPP ] ")
...
#    print (' Waktu : %s'%(datetime.now().strftime('%H:%M:%S'))
    print(" \033[0;32m[\033[0;32m+\033[0;36m]\033[0;00m============================================>")
    print(" \033[0;33m[\033[0;33m+\033[0;36m]\033[0;00m Username  : %s "%(nama))
    print(" \033[0;34m[\033[0;35m+\033[0;36m]\033[0;00m User id   : %s "%(id))
    print(" \033[0;35m[\033[0;35m+\033[0;36m]\033[0;00m Alamat ip : %s "%(IP))
    print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m============================================>")
    print(" \033[0;31m[\033[0;35m1\033[0;36m]\033[0;33m Starts Crack \033[0;00m[ \033[0;33mMULAI \033[0;00m]")
    print(" \033[0;32m[\033[0;35m2\033[0;36m]\033[0;00m Dump id Publick \033[0;36m[ \033[0;00m4000+ \033[0;36m]")
    ...
    print(" \033[0;32m[\033[0;35m5\033[0;36m]\033[0;00m Ganti user/agent \033[0;33m[ \033[0;35mSETTING \033[0;33m]")
    print(" \033[0;32m[\033[0;35m6\033[0;36m]\033[0;00m Chek hasil crack \033[0;33m[ \033[0;00mLIHAT \033[0;33m]")
    print(" \033[0;32m[\033[0;35m7\033[0;36m]\033[0;00m Chek opsi akun cp ")
    print(" \033[0;32m[\033[0;35m0\033[0;36m]\033[0;00m Delet [ TOKEN ] \033[0;33m[ \033[0;00mHAPUS \033[0;33m] ")
...
def gobloklu():
   ...
   jeeck("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m         ( Fb : https://www.facebook.com/ᎡᎬᎠ-ᎷᎪҒᏆᎪ-102896575436747/")
   jeeck("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m         ( Em : REDMAFIA@gmail.com")
